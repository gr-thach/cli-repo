...
const env = envalid.cleanEnv(process.env, {
  ...
  ES_URI: str({ default: '' }), // ES replication optional
  ...
  ACL_CACHE_EXPIRE_TIME: num({ default: 7200 }), // 2 hours
  ...
  const constantsByEnvironment = {
    default: {
      ...
      slackDevopsWebhookUrl:
        'https://hooks.slack.com/services/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', // guardrails-disable-line
      slackGrowthWebhookUrl:
        'https://hooks.slack.com/services/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', // guardrails-disable-line
