"use strict";
const { assertIsGitlabGroup, assertIsGitlabUser, assertHasMatchingGitlabGroup, assertAccountMatchesGitlabGroup, assertAccountMatchesGitlabUser } = require('../../src/helpers/assertGitlab');
    ...
    describe('assertIsGitlabGroup', () => {
        ...
        it("A Gitlab group without a path or full_path shouldn't pass assertion", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Gitlab group (123) to have either a path or a full_path.');
            }
        });
        it("A Gitlab group with a username shouldn't pass assertion (as this is probably a user and not a group).", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Gitlab group (123) to not have a username defined, is this a Gitlab user and not a group?.');
            }
        });
    });
    ...
    describe('assertHasMatchingGitlabGroup', () => {
        ...
        it("shouldn't pass assertion when an account doesn't have a matching Gitlab group", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected to find a matching Gitlab group for account (3) but non was found.');
            }
        });
    });
    describe('assertHasMatchingGitlabGroup', () => {
        ...
        it("shouldn't pass assertion as providerInternalId doesn't match Gitlab group.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected account (2, 999, ORGANIZATION, GITLAB) to match Gitlab group (123).');
            }
        });
    ...
    describe('assertAccountMatchesGitlabUser', () => {
        ...
        it("shouldn't pass assertion as providerInternalId on account doesn't match Gitlab user.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected account (2, 777, USER, GITLAB) to match Gitlab user (123).');
            }
        });
...
//# sourceMappingURL=assertGitlab.test.js.map