"use strict";
const { assertAccountsHasMatchingOrgProject, assertIsBitbucketOrgProjects, assertIsBitbucketOrgProject, assertAccountMatchesOrgProject, assertIsBitbucketPersonalProject, assertAccountMatchesPersonalProject } = require('../../src/helpers/assertBitbucketDataCenter');
    ...
    describe('assertIsBitbucketOrgProject', () => {
        ...
        it("A Bitbucket data center organization project without a project key shouldn't pass assertion", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center project (123) to have a project key.');
            }
        });
        it("A Bitbucket data center organization project with type set as PERSONAL shouldn't pass assertion", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center project (123) to be of type NORMAL, got PERSONAL.');
            }
        });
    });
    describe('assertIsBitbucketPersonalProject', () => {
        ...
        it("A Bitbucket data center personal project without a project key shouldn't pass assertion", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center personal project (789) to have a project key.');
            }
        });
        it("A Bitbucket data center personal project with type set as NORMAL shouldn't pass assertion", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center personal project (789) to be of type PERSONAL, got NORMAL.');
            }
        });
    });
    describe('assertAccountsHasMatchingOrgProject', () => {
        ...
        it("shouldn't pass assertion when an account doesn't have a matching Bitbucket data center organization project", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected to find a matching Project for account (3) but non was found.');
            }
        });
    });
    describe('assertAccountMatchesOrgProject', () => {
        ...
        it("shouldn't pass assertion as providerInternalId doesn't match Bitbucket data center organization project.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected account (2, 999, ORGANIZATION, BITBUCKET_DATA_CENTER) to match Bitbucket data center project (123).');
            }
        });
        it("shouldn't pass assertion as provider isn't BITBUCKET_DATA_CENTER.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected organization account provider to be BITBUCKET_DATA_CENTER');
            }
        });
        ...
        it("shouldn't pass assertion as Bitbucket data center organization project doesn't have a name.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center project (123) to not have a project name.');
            }
        });
    ...
    describe('assertAccountMatchesPersonalProject', () => {
        ...
        it("shouldn't pass assertion as providerInternalId doesn't match Bitbucket data center personal project.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected account (2, 999, USER, BITBUCKET_DATA_CENTER) to match Bitbucket data center project (789).');
            }
        });
        it("shouldn't pass assertion as provider isn't BITBUCKET_DATA_CENTER.", async () => {
            expect.hasAssertions();
        ...
        it("shouldn't pass assertion as Bitbucket data center personal project doesn't have a name.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center personal project (789) to not have a project name.');
            }
        });
        ...
        it("shouldn't pass assertion as Bitbucket data center personal project doesn't have an owner.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center personal project (789) to have an owner defined.');
            }
        });
        it("shouldn't pass assertion as Bitbucket data center personal project doesn't have an owner id.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center personal project (789) to have an owner id defined.');
            }
        });
    });
    describe('assertIsBitbucketOrgProjects', () => {
        ...
        it("shouldn't pass assertion as one organization project doesn't have a name.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center project (234) to not have a project name.');
            }
        });
        it("shouldn't pass assertion as one organization project doesn't have a key.", async () => {
            ...
            try {
                ...
                expect(err.message).toBe('Expected Bitbucket Data Center project (234) to have a project key.');
            }
        });
...
//# sourceMappingURL=assertBitbucketDataCenter.test.js.map