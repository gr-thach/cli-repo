...
const cache_1 = __importDefault(require("../../src/services/cache"));
...
describe('acl', () => {
    beforeEach(() => {
        ...
        cache_1.default.prototype.getInstance = mockGetInstance;
    });
    afterEach(() => {
        jest.clearAllMocks();
        jest.resetAllMocks();
    ...
    describe('getAllowedAccountsByUser', () => {
        it('should return allowedAccounts object and isSynchronizing = false', async () => {
            ...
            const result = await (0, acl_1.getAllowedAccountsByUser)(user);
