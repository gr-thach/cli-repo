...
describe('Repositories core-api', () => {
    ...
    describe('findRepositoryWithAccountByCliToken', () => {
        it.only('it should return repository with account', async () => {
            ...
            const repository = await repositoriesCore.findRepositoryWithAccountByCliToken('cliToken', 'name');
        ...
        it('it should return null', async () => {
            ...
            const account = await repositoriesCore.findRepositoryWithAccountByCliToken('cliToken', 'name');
