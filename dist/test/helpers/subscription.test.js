...
const subscription_1 = require("../../src/helpers/subscription");
...
describe('helpers/subscription', () => {
    ...
    describe('getFeatureValue', () => {
        it('should return private repos value', async () => {
            const privateRepos = await (0, subscription_1.getFeatureValue)(subscription, 'PRIVATE_REPOSITORIES');
            expect(privateRepos).toEqual(20);
        });
        it('should fail for null subscription', async () => {
            expect.assertions(1);
            try {
                await (0, subscription_1.getFeatureValue)(null, 'PRIVATE_REPOSITORIES');
            }
            catch (error) {
        ...
        it("shouldn't fail for null subscription when onpremise env", async () => {
            ...
            const privateRepos = await (0, subscription_1.getFeatureValue)(null, 'PRIVATE_REPOSITORIES');
