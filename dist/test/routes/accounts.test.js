...
describe('Accounts route', () => {
    ...
    beforeAll(async () => {
        ...
        const jwt = auth.generateJWT([{ provider: 'github', username: 'nickname', access_token: 'token' }], expiresAt);
    ...
    describe('GET /v2/accounts', () => {
        it('should return accounts that have access to', async () => {
            ...
            getAccountPermissionForUserMock.mockReturnValueOnce({
                read: [],
                write: [interfaces_1.Resource.ACCOUNTS, interfaces_1.Resource.CUSTOM_CONFIG, interfaces_1.Resource.SAML, interfaces_1.Resource.USERS]
            });
    ...
    describe('PATCH /v2/accounts/configuration', () => {
        ...
        it.skip('should update installation', async () => {
            moxios_1.default.stubRequest('https://api.github.com/user/installations', {
                statusCode: 200,
                response: {
                    installations: [
                        {
            ...
            moxios_1.default.stubRequest('http://core-api/graphql', {
                statusCode: 200,
                response: {
                    data: {
