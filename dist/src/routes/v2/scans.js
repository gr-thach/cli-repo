...
const ScansController = __importStar(require("../../controllers/scans"));
 ...
 *
 */
router.get('/lastPerRepo', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.READ, interfaces_1.Resource.SCANS, false), (0, celebrate_1.celebrate)({
 ...
 */
router.get('/', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.READ, interfaces_1.Resource.SCANS, false), (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: celebrate_1.Joi.object({
        repositoryIds: celebrate_1.Joi.string(),
        ...
        sha: celebrate_1.Joi.string(),
        sender: celebrate_1.Joi.string(),
        hasVulnerabilities: celebrate_1.Joi.string(),
        ...validations_1.validateAccountId,
        ...validations_1.validateLimit,
 ...
 *                        type: array
 */
router.get('/filters', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.READ, interfaces_1.Resource.SCANS, false), ScansController.filters);
/**
 * @swagger
 *  /v2/scans/bulk:
 *    patch:
 ...
 */
router.post('/bulk', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.WRITE, interfaces_1.Resource.SCANS, false), (0, celebrate_1.celebrate)({
 ...
 *
 */
router.post('/:repositoryId', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.WRITE, interfaces_1.Resource.SCANS, false), (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: celebrate_1.Joi.object({
 ...
 *                                      example: "f63e3c55-dca9-4a32-afe9-9e12b4a8aa04"
 */
router.put('/:repositoryId', (0, permissionsMiddleware_1.default)(interfaces_1.PermissionAction.WRITE, interfaces_1.Resource.SCANS, false), (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: celebrate_1.Joi.object({
        scanId: celebrate_1.Joi.string().required(),
        ...validations_1.validateAccountId
    }),
    [celebrate_1.Segments.PARAMS]: celebrate_1.Joi.object({
        repositoryId: celebrate_1.Joi.number()
