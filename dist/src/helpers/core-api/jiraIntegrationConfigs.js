...
const updateJiraIntegrationConfig = async (idJiraIntegrationConfig, patch) => {
    if (!patch) {
        throw new Error(`Patch was null or undefined when updating jira integration config '${idJiraIntegrationConfig}'.`);
    }
    const query = gql `
...
const deleteJiraIntegrationConfig = idJiraIntegrationConfig => updateJiraIntegrationConfig(idJiraIntegrationConfig, { deletedAt: new Date().toJSON() });
module.exports = {
...
//# sourceMappingURL=jiraIntegrationConfigs.js.map