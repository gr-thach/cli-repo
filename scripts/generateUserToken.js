...
const {
  ...
  GUARDRAILS_GIT_TOKENS_SECRET,
  GUARDRAILS_JWT_TOKEN_SECRET,
  GUARDRAILS_SESSION_KEY_1,
  GUARDRAILS_SESSION_KEY_2
} = process.env;
...
const generateUserToken = async () => {
  ...
  console.log('---');
  console.log(
    `document.cookie="gr.auth.is.authenticated=true;secure;SameSite=Lax;max-age=900;domain=.guardrails.io;path=/;";document.cookie="gr.auth.token=${base64Token};secure;SameSite=Lax;max-age=900;domain=.guardrails.io;path=/;";document.cookie="gr.auth.token.sig=${sig};secure;SameSite=Lax;max-age=900;domain=.guardrails.io;path=/;";window.location='/';`
  );
};
