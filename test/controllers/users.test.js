import { list } from '../../src/controllers/user';
import { queryUsers } from '../../src/helpers/core-api/users';
...
describe('Users controller', () => {
  ...
  describe('list users', () => {
    it('Should return users.', async () => {
      ...
      queryUsers.mockReturnValueOnce({ users, totalCount: 2 });
      ...
      expect(queryUsers).toBeCalledWith(
        1,
        { teamId: undefined, search: undefined, role: undefined },
        0,
        16
      );
    });
